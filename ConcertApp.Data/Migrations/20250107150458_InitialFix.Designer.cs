...
namespace ConcertApp.Data.Migrations
{
    ...
    [Migration("20250107150458_InitialFix")]
            ...
            modelBuilder.Entity("ConcertApp.Data.Entity.Performance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ConcertId = 1,
                            DateTime = new DateTime(2025, 1, 7, 16, 4, 57, 729, DateTimeKind.Utc).AddTicks(2538),
                            Location = "Main Stage",
                            Name = "Opening Act"
                        },
                        new
                        {
                            ID = 2,
                            ConcertId = 1,
                            DateTime = new DateTime(2025, 1, 7, 18, 4, 57, 729, DateTimeKind.Utc).AddTicks(3057),
                            Location = "Main Stage",
                            Name = "Metallica"
                        },
                        new
                        {
                            ID = 3,
                            ConcertId = 2,
                            DateTime = new DateTime(2025, 1, 8, 17, 4, 57, 729, DateTimeKind.Utc).AddTicks(3062),
                            Location = "Jazz Club",
                            Name = "Jazz Ensemble"
                        });
                });
